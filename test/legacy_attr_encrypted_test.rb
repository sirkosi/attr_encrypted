...
class LegacyAttrEncryptedTest < Minitest::Test
  ...
  def test_should_store_email_in_encrypted_attributes
    assert LegacyUser.encrypted_attrs.include?(:email)
  end

  def test_should_not_store_salt_in_encrypted_attributes
    assert !LegacyUser.encrypted_attrs.include?(:salt)
  end
  ...
  def test_attr_encrypted_should_not_use_the_same_attribute_name_for_two_attributes_in_the_same_line
    refute_equal LegacyUser.encrypted_attrs[:email][:attribute], LegacyUser.encrypted_attrs[:without_encoding][:attribute]
  end
  ...
  def test_should_inherit_encrypted_attributes
    assert_equal [LegacyUser.encrypted_attrs.keys, :testing].flatten.collect { |key| key.to_s }.sort, LegacyAdmin.encrypted_attrs.keys.collect { |key| key.to_s }.sort
  end
  ...
  def test_should_not_inherit_unrelated_attributes
    ...
    assert LegacySomeOtherClass.encrypted_attrs.empty?
  end
  ...
  def test_should_work_with_aliased_attr_encryptor
    assert LegacyUser.encrypted_attrs.include?(:aliased)
  end
